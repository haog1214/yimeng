      ...
      <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            <Link href="/" className="text-sm transition-colors duration-300 tracking-wide" style={navStyle()}>首頁</Link>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {SERVICE_FEATURES.map(({ title, en, desc, svg }) => (
              <div key={title}
                className="group flex flex-col items-center text-center p-8 rounded-2xl border border-gray-100 hover:border-red-100 hover:shadow-lg transition-all duration-300"
